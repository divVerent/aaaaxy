...
The current version is v1.6.271. Download here:
 - [Windows x86_64
ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.6.271/aaaaxy-windows-amd64-v1.6.271.zip)

- [Windows x86
  ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.6.271/aaaaxy-windows-386-v1.6.271.zip)
- [Linux x86_64
  AppImage](https://github.com/divVerent/aaaaxy/releases/download/v1.6.271/AAAAXY-x86_64.AppImage)
- [Linux x86_64
  ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.6.271/aaaaxy-linux-amd64-v1.6.271.zip)
- [macOS x86_64+M1
  ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.6.271/aaaaxy-darwin-v1.6.271.zip)
- [All files and releases](https://github.com/divVerent/aaaaxy/releases)
