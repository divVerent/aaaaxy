...
The current version is v1.5.183. Download here:

-   [Windows x86_64
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.5.183/aaaaxy-windows-amd64-v1.5.183.zip)
-   [Windows x86
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.5.183/aaaaxy-windows-386-v1.5.183.zip)
-   [Linux x86_64
    AppImage](https://github.com/divVerent/aaaaxy/releases/download/v1.5.183/AAAAXY-x86_64.AppImage)
-   [Linux x86_64
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.5.183/aaaaxy-linux-amd64-v1.5.183.zip)
-   [macOS x86_64+M1
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.5.183/aaaaxy-darwin-v1.5.183.zip)
-   [All files and
