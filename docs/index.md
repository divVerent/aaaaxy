...
The current version is v1.0.89. Download here:

  - [Windows x86\_64
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.0.89/aaaaxy-windows-amd64-v1.0.89.zip)
  - [Windows x86
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.0.89/aaaaxy-windows-386-v1.0.89.zip)
  - [Linux x86\_64
    AppImage](https://github.com/divVerent/aaaaxy/releases/download/v1.0.89/AAAAXY-x86_64.AppImage)
  - [Linux x86\_64
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.0.89/aaaaxy-linux-amd64-v1.0.89.zip)
  - [macOS x86\_64+M1
    ZIP](https://github.com/divVerent/aaaaxy/releases/download/v1.0.89/aaaaxy-darwin-v1.0.89.zip)
  - [All files and
