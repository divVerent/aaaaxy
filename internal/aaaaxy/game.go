...
var (
	...
	palette                 = flag.String("palette", "none", "render with palette (slow, ugly, fun); can be set to 'mono', 'cga40l', 'cga40h', 'cga40n', 'cga41l', 'cga41h', 'cga41n', 'cga5l', 'cga5h', 'ega', 'vga', 'web', '2x2x2', '4x4x4', '7x7x4' or 'none'")
